...
public class ClosedParanthesis extends Paranthesis{
  ...
  public ClosedParanthesis(int[] cardValues, int height, String expression, int paranRatio, int paranSpacing) {
    ...
    if(paranRatio <= 0 && paranSpacing > 2) { //make sure that there are an appropriate number of matching parantheses so far and that parans are around more than one symbol
